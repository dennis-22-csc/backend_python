...
from v1.oauth.views.utils import save_token
...
def access_token():
    ...
    token_saved = save_token(access_token_dict)
    if not token_saved:
...
def gen_auth_code():
    ...
    return jsonify("Auth code sent to email"), 201
